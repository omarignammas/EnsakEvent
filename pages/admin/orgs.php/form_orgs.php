        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="form_orgs.php"><i class="fas fa-user"></i><span>Organisateur</span></a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Demande organisateur</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                ...
                                <thead>
                                    ...
                                    <tbody>
            <?php
$sql = "SELECT * FROM organisateur WHERE mail_org<>'ensakenitraadm@gmail.com'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td class='text-center'>{$row['mail_org']}</td>";
        echo "<td class='text-center'>{$row['nom_org']}</td>";
        echo "<td class='text-center'>{$row['type']}</td>";
        echo "<td class='text-center'>{$row['nom_rep']}</td>";
        echo "<td class='text-center'>{$row['prenom_rep']}</td>";
