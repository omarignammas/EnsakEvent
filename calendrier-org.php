    ...
    <div id="wrapper">
        <nav class="navbar fixed-top align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <li class="nav-item"><a class="nav-link"  href="pages\organisateur\dashebord.php"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                <li class="nav-item"><a class="nav-link" href="pages/organisateur/dem_event/form-prom.php"><i class="far fa-clock"></i><span>Créer Evenement</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="pages/organisateur/dem_event/etat-form-event.php"><i class="fas fa-clock"></i><span>Etat demandes</span></a></li>
                    <li class="nav-item"><a class="nav-link"  href="pages/organisateur/dem_event/org_event.php"><i class="fas fa-clock"></i><span>Participants</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="calendrier-org.php"><i class="fas fa-table"></i><span>Calendrier</span></a></li>
