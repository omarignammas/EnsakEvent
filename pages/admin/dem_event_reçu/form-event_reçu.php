        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../dem_org_reçu/form_org_reçu.php"><i class="fas fa-table"></i><span>Demande Organisateur</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="form-event_reçu.php"><i class="fas fa-table"></i><span>Demande Evenement</span></a></li>
...
if (mysqli_num_rows($result) > 0) {
    while ($row= mysqli_fetch_assoc($result)) {
        ...
        echo "<tr>";
        echo "<td><img class='rounded-circle me-2' width='50' height='50' src='../../../assets/img/avatars/avatar1.jpeg'></td>";
        echo "<td>{$row['mail']}</td>";
        ...
        echo "<td>{$row['gsm']}</td>";
        echo "<td>";
        echo "<button type='submit' name='validation' class='btn btn-success btn-sm ms-2'><a href='trait-prom_reçu.php?id={$row['id_event']}' class='text-white text-decoration-none d-inline-block p-2' >Voir en d&eacutetails</a></button>";
        echo "</td>";        
        echo "</tr>";
    }
} else {
